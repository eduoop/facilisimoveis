        ...
        <div className='w-screen h-[50vh] flex justify-center items-center'>
            <div className='flex w-full max-w-[1250px] justify-center items-center gap-28 sm:w-[90%]'>
                ...
                <div className='flex flex-col p-5 border-4 border-solid border-primary rounded-md'> 
                    ...
                    <a href='https://wa.me/3198825154' target='_blank' className='flex transition duration-200 items-center gap-2 border-solid border-2 border-primary font-bold outline-none w-full justify-center bg-primary text-slate-950 py-3 shadow-lg rounded-md mt-6 text-xl hover:bg-primary/80 hover:shadow-none' rel="noreferrer">Contate-nos</a>
                </div>
            </div>
        </div>
    )
